  ...
  <div class="row">
    <div class="col m10 offset-m1 s12">
      <h5 class="custom-grey-text page-title">
        ...
        <a
          :href="`/portfolios/${portfolio.id}/payments`"
          class="right chip custom-orange white-text"
        >
        ...
        <form>
          <div class="row">
            ...
            <div class="col l2 m2 s12 slug-actions hide-on-small-and-down">
              <i
                class="far fa-copy element tooltipped"
            ...
            <div class="col l2 m2 s6 center">
              <label class="font_16 custom-grey-text text-darken-1">
                ...
                <i
                  class="fa fa-info-circle tooltipped"
                  data-tooltip="Aparece nas pesquisas por candidatos"
                ></i>
              </label>
              <div class="switch">
                <label>
                  <input
                    name="portfolio[listed]"
                    v-model="portfolio.listed"
                    type="checkbox"
                    @change="update()"
                  />
                  <span class="lever"></span>
          ...
          <div class="row">
            ...
            <div class="input-field col l2 offset-m1 m4 s6">
              <label>
                <input
                  name="portfolio[remote_ok]"
                  v-model="portfolio.remote_ok"
                  type="checkbox"
                  class="filled-in"
                  @change="update()"
                />
...
export default {
  ...
  created() {
    ...
    this.$resource("/portfolios{/id}")
      .get({ id: this.portfolio.id })
      .then(
        response => {
  ...
  methods: {
    update() {
      this.$resource("/portfolios{/id}")
        .update({ id: this.portfolio.id }, { portfolio: this.portfolio })
        .then({}, response => {
          this.portfolio = response.body.portfolio;
